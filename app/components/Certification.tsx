    ...
    <div className="certification-item bg-white border border-neutral-200 p-6 flex flex-col justify-between shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-none">
      <div>
        <div className="flex items-center gap-4 mb-4">
          {iconUrl && (
            <div className="w-10 h-10 flex items-center justify-center border border-neutral-200 bg-neutral-50 p-1.5 shrink-0 rounded-none">
              <img
                src={iconUrl}
                alt={`${issuer} icon`}
          ...
          <div>
            <h3 className="text-base font-bold text-neutral-900 leading-tight font-sans">
              {name}
            </h3>
        ...
        {description && (
          <p className="text-sm md:text-base text-neutral-600 mb-4 font-sans">
            {description}
          </p>
        )}
      </div>
